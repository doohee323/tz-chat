...
--
-- Table structure for table `at_priv`
--

DROP TABLE IF EXISTS `at_priv`;
...
CREATE TABLE `at_priv` (
  ...
  `priv_expl` varchar(2000) DEFAULT NULL,
...
--
-- Dumping data for table `at_priv`
--

LOCK TABLES `at_priv` WRITE;
/*!40000 ALTER TABLE `at_priv` DISABLE KEYS */;
/*!40000 ALTER TABLE `at_priv` ENABLE KEYS */;
UNLOCK TABLES;
